...
public class VerifyPageElementsExists_TEST_TestNG extends SeleniumHelperBasic{
	...
	public void VerifyPageElementsExists() throws InterruptedException {
    	...
    	else
    	{
	    	...
	    	softAssertion.assertTrue(Local_POM_AmexHomePage.Free_Credit_Score_Report_DISPLAYED());
	    	softAssertion.assertTrue(Local_POM_AmexHomePage.CreditSecure_DISPLAYED());
